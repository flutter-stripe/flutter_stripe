...
mixin _$PaymentMethodMessagingConfiguration {
 ...
 List<PaymentMethodMessagingPaymentMethod> get paymentMethods; String get currency; int get amount; String? get countryCode;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(paymentMethods),currency,amount,countryCode);

@override
String toString() {
  return 'PaymentMethodMessagingConfiguration(paymentMethods: $paymentMethods, currency: $currency, amount: $amount, countryCode: $countryCode)';
}
...
@useResult
$Res call({
 List<PaymentMethodMessagingPaymentMethod> paymentMethods, String currency, int amount, String? countryCode
});
...
/// Create a copy of PaymentMethodMessagingConfiguration
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? paymentMethods = null,Object? currency = null,Object? amount = null,Object? countryCode = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<PaymentMethodMessagingPaymentMethod> paymentMethods,  String currency,  int amount,  String? countryCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentMethodMessagingConfiguration() when $default != null:
return $default(_that.paymentMethods,_that.currency,_that.amount,_that.countryCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<PaymentMethodMessagingPaymentMethod> paymentMethods,  String currency,  int amount,  String? countryCode)  $default,) {final _that = this;
switch (_that) {
case _PaymentMethodMessagingConfiguration():
return $default(_that.paymentMethods,_that.currency,_that.amount,_that.countryCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<PaymentMethodMessagingPaymentMethod> paymentMethods,  String currency,  int amount,  String? countryCode)?  $default,) {final _that = this;
switch (_that) {
case _PaymentMethodMessagingConfiguration() when $default != null:
return $default(_that.paymentMethods,_that.currency,_that.amount,_that.countryCode);case _:
  return null;
...
class _PaymentMethodMessagingConfiguration implements PaymentMethodMessagingConfiguration {
  const _PaymentMethodMessagingConfiguration({required final  List<PaymentMethodMessagingPaymentMethod> paymentMethods, required this.currency, required this.amount, this.countryCode}): _paymentMethods = paymentMethods;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_paymentMethods),currency,amount,countryCode);
...
/// Create a copy of PaymentMethodMessagingConfiguration
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? paymentMethods = null,Object? currency = null,Object? amount = null,Object? countryCode = freezed,}) {
