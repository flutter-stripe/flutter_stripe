...
/// @nodoc
abstract class _$$ApplePayShippingContactImplCopyWith<$Res>
    implements $ApplePayShippingContactCopyWith<$Res> {
  factory _$$ApplePayShippingContactImplCopyWith(
          _$ApplePayShippingContactImpl value,
          $Res Function(_$ApplePayShippingContactImpl) then) =
      __$$ApplePayShippingContactImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? emailAddress,
...
/// @nodoc
class __$$ApplePayShippingContactImplCopyWithImpl<$Res>
    extends _$ApplePayShippingContactCopyWithImpl<$Res,
        _$ApplePayShippingContactImpl>
    implements _$$ApplePayShippingContactImplCopyWith<$Res> {
  __$$ApplePayShippingContactImplCopyWithImpl(
      _$ApplePayShippingContactImpl _value,
      $Res Function(_$ApplePayShippingContactImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ApplePayShippingContactImpl(
      emailAddress: freezed == emailAddress
          ? _value.emailAddress
          : emailAddress // ignore: cast_nullable_to_non_nullable
              as String?,
...
@JsonSerializable(explicitToJson: true)
class _$ApplePayShippingContactImpl implements _ApplePayShippingContact {
  const _$ApplePayShippingContactImpl(
      {this.emailAddress,
      required this.name,
      required this.postalAddress,
      this.phoneNumber});

  factory _$ApplePayShippingContactImpl.fromJson(Map<String, dynamic> json) =>
      _$$ApplePayShippingContactImplFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ApplePayShippingContactImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ApplePayShippingContactImplCopyWith<_$ApplePayShippingContactImpl>
      get copyWith => __$$ApplePayShippingContactImplCopyWithImpl<
          _$ApplePayShippingContactImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ApplePayShippingContactImplToJson(
      this,
    );
  }
}
...
abstract class _ApplePayShippingContact implements ApplePayShippingContact {
  const factory _ApplePayShippingContact(
      ...
      final String? phoneNumber}) = _$ApplePayShippingContactImpl;

  factory _ApplePayShippingContact.fromJson(Map<String, dynamic> json) =
      _$ApplePayShippingContactImpl.fromJson;
