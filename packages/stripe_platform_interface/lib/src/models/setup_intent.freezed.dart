...
/// Unique identifier.
 String get id;/// Status of the intent.
///
/// See https://stripe.com/docs/payments/intents#intent-statuses.
 ...
 String? get created;/// Error encountered since last configmration.
...
/// using the provided resource.
 NextAction? get nextAction;/// Mandata data for this paymentintent.
 MandateData? get mandateData;
/// Create a copy of SetupIntent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SetupIntentCopyWith<SetupIntent> get copyWith => _$SetupIntentCopyWithImpl<SetupIntent>(this as SetupIntent, _$identity);
...
$LastSetupErrorCopyWith<$Res>? get lastSetupError;$NextActionCopyWith<$Res>? get nextAction;$MandateDataCopyWith<$Res>? get mandateData;

}
/// @nodoc
class _$SetupIntentCopyWithImpl<$Res>
...
/// Create a copy of SetupIntent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = null,Object? livemode = null,Object? clientSecret = null,Object? paymentMethodId = null,Object? usage = null,Object? paymentMethodTypes = null,Object? description = freezed,Object? created = freezed,Object? lastSetupError = freezed,Object? nextAction = freezed,Object? mandateData = freezed,}) {
...
as bool,clientSecret: null == clientSecret ? _self.clientSecret : clientSecret // ignore: cast_nullable_to_non_nullable
...
as LastSetupError?,nextAction: freezed == nextAction ? _self.nextAction : nextAction // ignore: cast_nullable_to_non_nullable
...
extension SetupIntentPatterns on SetupIntent {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SetupIntent value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SetupIntent value)  $default,){
final _that = this;
switch (_that) {
case _SetupIntent():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SetupIntent value)?  $default,){
final _that = this;
switch (_that) {
case _SetupIntent() when $default != null:
return $default(_that);case _:
...
/// List of payment method types associated with this intent.
@override List<PaymentMethodType> get paymentMethodTypes {
...
@override final  LastSetupError? lastSetupError;
...
@pragma('vm:prefer-inline')
_$SetupIntentCopyWith<_SetupIntent> get copyWith => __$SetupIntentCopyWithImpl<_SetupIntent>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SetupIntentToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SetupIntent&&(identical(other.id, id) || other.id == id)&&(identical(other.status, status) || other.status == status)&&(identical(other.livemode, livemode) || other.livemode == livemode)&&(identical(other.clientSecret, clientSecret) || other.clientSecret == clientSecret)&&(identical(other.paymentMethodId, paymentMethodId) || other.paymentMethodId == paymentMethodId)&&(identical(other.usage, usage) || other.usage == usage)&&const DeepCollectionEquality().equals(other._paymentMethodTypes, _paymentMethodTypes)&&(identical(other.description, description) || other.description == description)&&(identical(other.created, created) || other.created == created)&&(identical(other.lastSetupError, lastSetupError) || other.lastSetupError == lastSetupError)&&(identical(other.nextAction, nextAction) || other.nextAction == nextAction)&&(identical(other.mandateData, mandateData) || other.mandateData == mandateData));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,status,livemode,clientSecret,paymentMethodId,usage,const DeepCollectionEquality().hash(_paymentMethodTypes),description,created,lastSetupError,nextAction,mandateData);
...
/// @nodoc
abstract mixin class _$SetupIntentCopyWith<$Res> implements $SetupIntentCopyWith<$Res> {
...
@override $LastSetupErrorCopyWith<$Res>? get lastSetupError;@override $NextActionCopyWith<$Res>? get nextAction;@override $MandateDataCopyWith<$Res>? get mandateData;

}
/// @nodoc
class __$SetupIntentCopyWithImpl<$Res>
...
/// Create a copy of SetupIntent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? status = null,Object? livemode = null,Object? clientSecret = null,Object? paymentMethodId = null,Object? usage = null,Object? paymentMethodTypes = null,Object? description = freezed,Object? created = freezed,Object? lastSetupError = freezed,Object? nextAction = freezed,Object? mandateData = freezed,}) {
...
/// Code.
 String get code;/// Message.
 String get message;
/// Create a copy of LastSetupError
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LastSetupErrorCopyWith<LastSetupError> get copyWith => _$LastSetupErrorCopyWithImpl<LastSetupError>(this as LastSetupError, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LastSetupError&&(identical(other.code, code) || other.code == code)&&(identical(other.message, message) || other.message == message));
}
...
abstract mixin class $LastSetupErrorCopyWith<$Res>  {
  factory $LastSetupErrorCopyWith(LastSetupError value, $Res Function(LastSetupError) _then) = _$LastSetupErrorCopyWithImpl;
@useResult
$Res call({
...
extension LastSetupErrorPatterns on LastSetupError {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LastSetupError value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LastSetupError() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LastSetupError value)  $default,){
final _that = this;
switch (_that) {
case _LastSetupError():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LastSetupError value)?  $default,){
final _that = this;
switch (_that) {
case _LastSetupError() when $default != null:
return $default(_that);case _:
...
class _LastSetupError implements LastSetupError {
  ...
  factory _LastSetupError.fromJson(Map<String, dynamic> json) => _$LastSetupErrorFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$LastSetupErrorCopyWith<_LastSetupError> get copyWith => __$LastSetupErrorCopyWithImpl<_LastSetupError>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LastSetupErrorToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LastSetupError&&(identical(other.code, code) || other.code == code)&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class _$LastSetupErrorCopyWith<$Res> implements $LastSetupErrorCopyWith<$Res> {
  factory _$LastSetupErrorCopyWith(_LastSetupError value, $Res Function(_LastSetupError) _then) = __$LastSetupErrorCopyWithImpl;
@override @useResult
$Res call({
 String code, String message
});
