...
/// ISO 3166-1 alpha-2 country code where the transaction is processed.
 ...
 List<String>? get additionalEnabledNetworks;/// Set this property to only allow specific card networks for this payment, for example: ["Visa", "MasterCard"]. Overrides the default networks, including any set in `additionalEnabledNetworks`. A full list of possible networks can be found at https://developer.apple.com/documentation/passkit/pkpaymentnetwork.
