...
_ApplePaySheetErrorUnserviceableShipping
    _$ApplePaySheetErrorUnserviceableShippingFromJson(
            Map<String, dynamic> json) =>
        _ApplePaySheetErrorUnserviceableShipping(
          message: json['message'] as String?,
          $type: json['errorType'] as String?,
...
PlatformPayConfirmParamsGooglePay _$PlatformPayConfirmParamsGooglePayFromJson(
    ...
    PlatformPayConfirmParamsGooglePay(
      googlePay:
          GooglePayParams.fromJson(json['googlePay'] as Map<String, dynamic>),
...
_ApplePayParams _$ApplePayParamsFromJson(Map<String, dynamic> json) =>
    _ApplePayParams(
...
Map<String, dynamic> _$ApplePayParamsToJson(_ApplePayParams instance) =>
    <String, dynamic>{
