...
mixin _$CardPaymentMethod {
  ...
  $CardPaymentMethodCopyWith<CardPaymentMethod> get copyWith =>
      _$CardPaymentMethodCopyWithImpl<CardPaymentMethod>(
          this as CardPaymentMethod, _$identity);
...
abstract mixin class $CardPaymentMethodCopyWith<$Res> {
  factory $CardPaymentMethodCopyWith(
          CardPaymentMethod value, $Res Function(CardPaymentMethod) _then) =
      _$CardPaymentMethodCopyWithImpl;
  @useResult
  $Res call(
      {String? brand,
      String? country,
...
class _CardPaymentMethod implements CardPaymentMethod {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CardPaymentMethodCopyWith<_CardPaymentMethod> get copyWith =>
      __$CardPaymentMethodCopyWithImpl<_CardPaymentMethod>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CardPaymentMethodToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$CardPaymentMethodCopyWith<$Res>
    implements $CardPaymentMethodCopyWith<$Res> {
  factory _$CardPaymentMethodCopyWith(
          _CardPaymentMethod value, $Res Function(_CardPaymentMethod) _then) =
      __$CardPaymentMethodCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? brand,
