...
mixin _$ConfirmSepaDebitPaymentData {
  ...
  $ConfirmSepaDebitPaymentDataCopyWith<ConfirmSepaDebitPaymentData>
      get copyWith => _$ConfirmSepaDebitPaymentDataCopyWithImpl<
          ...
          this as ConfirmSepaDebitPaymentData, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConfirmSepaDebitPaymentData &&
...
abstract mixin class $ConfirmSepaDebitPaymentDataCopyWith<$Res> {
  factory $ConfirmSepaDebitPaymentDataCopyWith(
          ...
          $Res Function(ConfirmSepaDebitPaymentData) _then) =
      _$ConfirmSepaDebitPaymentDataCopyWithImpl;
  @useResult
  $Res call(
...
class _$ConfirmSepaDebitPaymentDataCopyWithImpl<$Res>
  ...
  $SepaDebitPaymentMethodDetailsCopyWith<$Res>? get paymentMethod {
    ...
    return $SepaDebitPaymentMethodDetailsCopyWith<$Res>(_self.paymentMethod!,
        (value) {
...
class _ConfirmSepaDebitPaymentData implements ConfirmSepaDebitPaymentData {
  const _ConfirmSepaDebitPaymentData(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConfirmSepaDebitPaymentDataCopyWith<_ConfirmSepaDebitPaymentData>
      get copyWith => __$ConfirmSepaDebitPaymentDataCopyWithImpl<
          _ConfirmSepaDebitPaymentData>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConfirmSepaDebitPaymentDataToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConfirmSepaDebitPaymentData &&
            (identical(other.paymentMethod, paymentMethod) ||
                other.paymentMethod == paymentMethod) &&
            (identical(other.setupFutureUsage, setupFutureUsage) ||
                other.setupFutureUsage == setupFutureUsage));
...
/// @nodoc
abstract mixin class _$ConfirmSepaDebitPaymentDataCopyWith<$Res>
    implements $ConfirmSepaDebitPaymentDataCopyWith<$Res> {
  factory _$ConfirmSepaDebitPaymentDataCopyWith(
          _ConfirmSepaDebitPaymentData value,
          $Res Function(_ConfirmSepaDebitPaymentData) _then) =
      __$ConfirmSepaDebitPaymentDataCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@paymentMethodDetailJsonKey SepaDebitPaymentMethodDetails? paymentMethod,
...
SepaDebitPaymentMethodDetails _$SepaDebitPaymentMethodDetailsFromJson(
  ...
  switch (json['type']) {
    ...
    case 'sepa_debit':
      return _SepaDebitPaymentMethodDetailsElement.fromJson(json);
    case 'sepa_debit':
...
mixin _$SepaDebitPaymentMethodDetails {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SepaDebitPaymentMethodDetails);
  }
...
class $SepaDebitPaymentMethodDetailsCopyWith<$Res> {
  $SepaDebitPaymentMethodDetailsCopyWith(SepaDebitPaymentMethodDetails _,
      $Res Function(SepaDebitPaymentMethodDetails) __);
}

/// @nodoc
@JsonSerializable()
class _IdSepaDebitPaymentMethodDetails
    implements SepaDebitPaymentMethodDetails, IdPaymentMethodDetails {
  const _IdSepaDebitPaymentMethodDetails(this.id, {final String? $type})
      : $type = $type ?? 'sepa_debit';
  factory _IdSepaDebitPaymentMethodDetails.fromJson(
          Map<String, dynamic> json) =>
      _$IdSepaDebitPaymentMethodDetailsFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IdSepaDebitPaymentMethodDetailsCopyWith<_IdSepaDebitPaymentMethodDetails>
      get copyWith => __$IdSepaDebitPaymentMethodDetailsCopyWithImpl<
          _IdSepaDebitPaymentMethodDetails>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IdSepaDebitPaymentMethodDetailsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IdSepaDebitPaymentMethodDetails &&
...
/// @nodoc
abstract mixin class _$IdSepaDebitPaymentMethodDetailsCopyWith<$Res>
    implements $SepaDebitPaymentMethodDetailsCopyWith<$Res> {
  factory _$IdSepaDebitPaymentMethodDetailsCopyWith(
          _IdSepaDebitPaymentMethodDetails value,
          $Res Function(_IdSepaDebitPaymentMethodDetails) _then) =
      __$IdSepaDebitPaymentMethodDetailsCopyWithImpl;
  @useResult
  $Res call({String id});
}
...
/// @nodoc
@JsonSerializable()
class _SepaDebitPaymentMethodDetailsElement
    implements SepaDebitPaymentMethodDetails {
  const _SepaDebitPaymentMethodDetailsElement(
      {@JsonKey(name: "sepa_debit") @ElementConverter() required this.sepaDebit,
      @JsonKey(name: "billing_details") this.billingDetails,
      final String? $type})
      : $type = $type ?? 'sepa_debit';
  factory _SepaDebitPaymentMethodDetailsElement.fromJson(
          Map<String, dynamic> json) =>
      _$SepaDebitPaymentMethodDetailsElementFromJson(json);
  ...
  _$SepaDebitPaymentMethodDetailsElementCopyWith<
      ...
      get copyWith => __$SepaDebitPaymentMethodDetailsElementCopyWithImpl<
          _SepaDebitPaymentMethodDetailsElement>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SepaDebitPaymentMethodDetailsElementToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SepaDebitPaymentMethodDetailsElement &&
...
/// @nodoc
abstract mixin class _$SepaDebitPaymentMethodDetailsElementCopyWith<$Res>
    implements $SepaDebitPaymentMethodDetailsCopyWith<$Res> {
  factory _$SepaDebitPaymentMethodDetailsElementCopyWith(
          _SepaDebitPaymentMethodDetailsElement value,
          $Res Function(_SepaDebitPaymentMethodDetailsElement) _then) =
      __$SepaDebitPaymentMethodDetailsElementCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
@JsonSerializable()
class _SepaDebitPaymentMethodDetailsWithIban
    implements SepaDebitPaymentMethodDetails {
  const _SepaDebitPaymentMethodDetailsWithIban(
  ...
  factory _SepaDebitPaymentMethodDetailsWithIban.fromJson(
          Map<String, dynamic> json) =>
      _$SepaDebitPaymentMethodDetailsWithIbanFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SepaDebitPaymentMethodDetailsWithIbanCopyWith<
          _SepaDebitPaymentMethodDetailsWithIban>
      get copyWith => __$SepaDebitPaymentMethodDetailsWithIbanCopyWithImpl<
          _SepaDebitPaymentMethodDetailsWithIban>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SepaDebitPaymentMethodDetailsWithIbanToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SepaDebitPaymentMethodDetailsWithIban &&
            (identical(other.sepaDebit, sepaDebit) ||
                other.sepaDebit == sepaDebit) &&
            (identical(other.billingDetails, billingDetails) ||
                other.billingDetails == billingDetails));
...
/// @nodoc
abstract mixin class _$SepaDebitPaymentMethodDetailsWithIbanCopyWith<$Res>
    implements $SepaDebitPaymentMethodDetailsCopyWith<$Res> {
  factory _$SepaDebitPaymentMethodDetailsWithIbanCopyWith(
          _SepaDebitPaymentMethodDetailsWithIban value,
          $Res Function(_SepaDebitPaymentMethodDetailsWithIban) _then) =
      __$SepaDebitPaymentMethodDetailsWithIbanCopyWithImpl;
  @useResult
  $Res call(
...
mixin _$SepaDebitIbanData {
  ...
  $SepaDebitIbanDataCopyWith<SepaDebitIbanData> get copyWith =>
      _$SepaDebitIbanDataCopyWithImpl<SepaDebitIbanData>(
          this as SepaDebitIbanData, _$identity);
...
abstract mixin class $SepaDebitIbanDataCopyWith<$Res> {
  factory $SepaDebitIbanDataCopyWith(
          SepaDebitIbanData value, $Res Function(SepaDebitIbanData) _then) =
      _$SepaDebitIbanDataCopyWithImpl;
  @useResult
...
class _SepaDebitIbanData implements SepaDebitIbanData {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SepaDebitIbanDataCopyWith<_SepaDebitIbanData> get copyWith =>
      __$SepaDebitIbanDataCopyWithImpl<_SepaDebitIbanData>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SepaDebitIbanDataToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$SepaDebitIbanDataCopyWith<$Res>
    implements $SepaDebitIbanDataCopyWith<$Res> {
  factory _$SepaDebitIbanDataCopyWith(
          _SepaDebitIbanData value, $Res Function(_SepaDebitIbanData) _then) =
      __$SepaDebitIbanDataCopyWithImpl;
  @override
  @useResult
  $Res call({String iban});
}
...
mixin _$SepaBillingDetails {
  ...
  $SepaBillingDetailsCopyWith<SepaBillingDetails> get copyWith =>
      _$SepaBillingDetailsCopyWithImpl<SepaBillingDetails>(
          this as SepaBillingDetails, _$identity);
...
abstract mixin class $SepaBillingDetailsCopyWith<$Res> {
  factory $SepaBillingDetailsCopyWith(
          SepaBillingDetails value, $Res Function(SepaBillingDetails) _then) =
      _$SepaBillingDetailsCopyWithImpl;
  @useResult
  $Res call(
...
class _SepaBillingDetails implements SepaBillingDetails {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SepaBillingDetailsCopyWith<_SepaBillingDetails> get copyWith =>
      __$SepaBillingDetailsCopyWithImpl<_SepaBillingDetails>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SepaBillingDetailsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$SepaBillingDetailsCopyWith<$Res>
    implements $SepaBillingDetailsCopyWith<$Res> {
  factory _$SepaBillingDetailsCopyWith(
          _SepaBillingDetails value, $Res Function(_SepaBillingDetails) _then) =
      __$SepaBillingDetailsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String email, BillingAddress? address, String? phone, String name});
